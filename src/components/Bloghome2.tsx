          ...
          <div className="blog-entries">
            ...
            <div className="card mb-4">
                ...
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    ...
                    <p className="card-text">
                      การพัฒนาคุณภาพการบริหารจัดการภาครัฐในยุคใหม่จะต้องนำเทคโนโยลีดิจิทัลและเทคโนโลยีปัญญาประดิษฐ์มาใช้ในการบริหารจัดการองค์การ
              ...
              <div className="card-footer text-muted">
                โพสเมื่อวันที่ 8 มกราคม 2568 โดย
                <a href="#"> ณัฐณิชา จำเริญเศษ</a>
              </div>
            </div>
            {/* Blog Post */}
            <div className="card mb-4">
            ...
            <div className="card mb-4">
                ...
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    ...
                    <p className="card-text">
                      ...
                      เพื่อการพัฒนาคุณภาพการบริหารจัดการภาครัฐในยุคดิจิทัลและAI
                    </p>
                    <a
              ...
              <div className="card-footer text-muted">
                โพสเมื่อวันที่ 8 มกราคา 2568 โดย
                <a href="#"> ณัฐณิชา จำเริญเศษ</a>
              </div>
            </div>
          </div>
